...
class WordGenerator {
  ...
  static let possibleWords = ["FLOOR", "COLOR", "WHOLE", "STACK", "BUNNY", "CLEAN", "STRIP", "STEAK", "SONGS", "EXCEL", "LOVER", "CHILI", "BROKE", "BRUSH", "BORED", "PRINT", "ITCHY", "HONEY", "MANIA", "AMAZE", "WORRY", "WATER"]
  static func generateRandomWord() -> String? {
      //let random = possibleWords.randomElement()
